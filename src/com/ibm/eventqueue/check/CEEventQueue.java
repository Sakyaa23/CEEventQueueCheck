...
import javax.mail.internet.MimeMessage;
	...
	public class CEEventQueue
	{
		public String makeConnection(String ObjectStore) throws IOException
		{
			...
			javax.security.auth.Subject sub = UserContext.createSubject(connection,username,password,null);
			...
			//String mySQLString = "SELECT * FROM eventqueueitem WHERE DateCreated > Now() - TimeSpan(2, 'Days')";
	    	...
	    	if(rowSet.isEmpty())
	    	{
	    		//System.out.println(objectStore.get_Name()+":"+count);
	    		output=objectStore.get_Name()+":"+count;
	    	}
	    	else
			{
		...
		{
			CEEventQueue eqe=new CEEventQueue();
			...
			builder.append("<html>"+ 
				...
				"<br>Hi Team,"+
				"\n"+"<br>"+
			"Please find below the event queue count of the Object Stores."+"\n"+"<br>"+
				"<table border=1>"+
				"<tr bgcolor='#b2beb5'>"+
				"<th>Object Store</th>"+
				"<th>Count</th>");
				...
				for( i=0;i<12;i++)
				{
					...
					builder.append("\n");
			       builder.append("<br>");
			       builder.append("FileNetLightsOnTeam");
			       builder.append("\n");
			       builder.append("<br>");
